...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0e] text-slate-100 flex flex-col font-sans selection:bg-amber-500 selection:text-slate-950 pb-16 sm:pb-0 overflow-x-hidden">
